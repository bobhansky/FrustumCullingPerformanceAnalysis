...
int main()
{
	...
	Shader instanceShader("shaders/instance_gpu.vs", "shaders/fs.fs");
	ComputeShader computeShader("shaders/instance_compute.glsl");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		scene.draw_instance_compute(instanceShader, computeShader, camFrustum);
